...
void						setup_pipe_fds(t_shell *shell, int cmd_index,
								int cmd_count);
void						wait_all_children(t_shell *shell, int cmd_count);
void						close_unused_pipes(t_shell *shell, int cmd_count,
								int current_cmd);
...
int							process_heredoc_input(t_shell *shell,
								t_redir *redir, char *filename);
int							collect_heredoc_input(t_shell *shell,
